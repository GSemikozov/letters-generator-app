...
export const CopyIcon = ({ size = 20, className = '', 'aria-label': ariaLabel }: CopyIconProps) => {
  return (
    <svg
      width={size}
      height={size}
